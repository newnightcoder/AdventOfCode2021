...
const printHorizontalPos = () => {
  for (let direction of directions) {
    ...
    if (Object.keys(direction).includes("down")) {
      depthArray.push(parseInt(-Object.values(direction)));
    }
    if (Object.keys(direction).includes("up")) {
      depthArray.push(parseInt(Object.values(direction)));
    }
  }
  ...
  depthPos = depthArray.reduce((acc, curr) => {
    return acc + curr;
  });
...
const printDepthPos = () => {
  for (let direction of directions) {
    if (Object.keys(direction).includes("down")) {
      ...
      aim = aimArray.reduce((acc, current) => {
        return acc + current;
      });
    }
    if (Object.keys(direction).includes("up")) {
  ...
  depthPos = depthArray.reduce((acc, current) => {
    return acc + current;
  });
  console.log(horizontalPos * depthPos);
};
